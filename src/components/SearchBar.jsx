    ...
    <div className="glass-strong rounded-2xl shadow-xl shadow-gray-200/50 p-6 mb-6">
      <div className="relative">
        ...
        <input
          ...
          placeholder={disabled ? 'انتهت عمليات البحث المجانية اليوم — ترقَّ للباقة المميزة' : 'ابحث عن مكوّن... مثال: E471، جيلاتين، Gelatin'}
          className={`w-full pr-14 pl-4 py-4 text-lg border-2 rounded-xl focus:outline-none transition-all duration-300 font-medium placeholder-gray-400 ${
            disabled
