  ...
  return (
    <section className="relative overflow-hidden pt-24 pb-20 sm:pt-32 sm:pb-28">
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10 flex flex-col items-center justify-center">
        {/* Badge */}
        <div className="inline-flex items-center gap-2 bg-emerald-50 border border-emerald-200 rounded-full px-5 py-2 mb-10 animate-slide-up">
        ...
        {/* Main heading */}
        <h1 className="text-4xl sm:text-5xl md:text-6xl font-black text-gray-900 mb-8 leading-tight animate-slide-up" style={{animationDelay: '0.1s'}}>
          هل هذا المكوّن{' '}
          <span className="gradient-text">حلال؟</span>
        </h1>
        
        {/* Subtitle */}
        <p className="text-gray-500 text-base sm:text-lg md:text-xl max-w-2xl mx-auto mb-0 animate-slide-up leading-relaxed" style={{animationDelay: '0.15s'}}>
